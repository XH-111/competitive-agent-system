...
export const api = {
  ...
  updateTaskHighlight: (taskId: string, isHighlighted: boolean) =>
    request<Task>(`/api/tasks/${taskId}/highlight`, { label: "updateTaskHighlight", method: "PATCH", body: JSON.stringify({ is_highlighted: isHighlighted }) }),
